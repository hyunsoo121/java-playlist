    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (!lsm.isSelectionEmpty()) {
            ...
            if (tableTitle.equals("item")) {
                ...
                // selectedIndex 행의 0번째 열 (=제목)을 loadData 의 인수로 보내 일치하는 Music 을 albumMusicTable 에 보여지도록 합니다.
                ...
                // selectedIndex 행의 0번째 열 (=id)를 loadPlaylist 의 인수로 보내 PlaylistMgr 이 일치하는 id의 ArrayList 를 반환하도록 합니다.
                TableModel data = table.getModel();
